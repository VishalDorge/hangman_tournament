...
exports.GENERATE_TOKEN_VALIDATION = exports.CREATE_USER_VALIDATION = exports.LOGIN_VALIDATION = void 0;
...
exports.CREATE_USER_VALIDATION = [
    (0, express_validator_1.body)("username").isString().isLength({ min: 1 }).withMessage("Name Required!"),
    (0, express_validator_1.body)("email").isEmail().withMessage("Invalid Email!"),
    (0, express_validator_1.body)("password").isLength({ min: 5 }).withMessage("Invalid Password"),
    input_validate_1.inputValidator
];
